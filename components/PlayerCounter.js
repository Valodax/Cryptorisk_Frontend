...
export default function PlayerCounter() {
    ...
    async function updatePlayerUI() {
        ...
        try {
            ...
            setPlayer2(player2.slice(0, 6) + "..." + player2.slice(-6, player2.length));
            setPlayer3(player3.slice(0, 6) + "..." + player3.slice(-6, player3.length));
            setPlayer4(player4.slice(0, 6) + "..." + player4.slice(-6, player4.length));
        } catch {
